...
insert into articulos(nombre_articulo,descripcion,precio,stock,url,categoria)values ('Compresor de Refrigeración','orem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt',
    ...
    ('Aire Acondicionado Split','Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt',420000.00,20,  'https://picsum.photos/150?random=13','climatizacion'),
     ('Calefactor Eléctrico','Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt',  120000.00, 20, 'https://picsum.photos/150?random=14' ,'climatizacion'),
      ...
      ('Repuesto X','Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt', 25000.00,20, 'https://picsum.photos/150?random=25','productos completos'),
      ('Repuesto Y','Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt', 30000.00,20, 'https://picsum.photos/150?random=26','productos completos'),
      ('Compresor Hermético','Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt',290000.00,20,'https://picsum.photos/150?random=27','productos completos'),
      ('Tubo Capilar','Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt', 12000.00, 20,'https://picsum.photos/150?random=28','productos completos'),
      ('Motor de Ventilador','Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt', 85000.00,20, 'https://picsum.photos/150?random=29','productos completos'),
      ('Bobina de Cobre','Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt', 110000.00,20, 'https://picsum.photos/150?random=30','productos completos'),
      ('Condensador de Aire Acondicionado','Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt', 275000.00,20, 'https://picsum.photos/150?random=31','productos completos'),
      ('Unidad Exterior de Aire Acondicionado','Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt', 500000.00,20, 'https://picsum.photos/150?random=32','productos completos'),
      ('Tarjeta Electrónica de Control', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt',160000.00,20, 'https://picsum.photos/150?random=33','productos completos'),
      ('Filtro de Secador','Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quae asperiores saepe laboriosam suscipit deserunt', 22000.00, 20,'https://picsum.photos/150?random=34','productos completos');